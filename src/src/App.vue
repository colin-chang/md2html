<template>
  <div id="app">
    <div class="main">
          ...
          <div id="ids" v-html="html" style="width: 1200px; " v-highlight  class="center contentss"></div>
...
<style>
   table{border-right:1px solid #ccc;border-bottom:1px solid #ccc; color: #8e8e8e}
  table td{border-left:1px solid #ccc;border-top:1px solid #ccc ; padding: 3px;}
   table th{border-left:1px solid #ccc;border-top:1px solid #ccc; padding: 3px;}
  .contentss{
